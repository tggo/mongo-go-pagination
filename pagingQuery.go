...
type PagingQuery interface {
	...
	TotalCount(total int64) PagingQuery
...
func (paging *pagingQuery) TotalCount(total int64) PagingQuery {
	paging.ForceTotalCount = total
	return paging
}
...
func (paging *pagingQuery) Find() (paginatedData *PaginatedData, err error) {
	...
	if paging.ForceTotalCount > 0 {
		Paging(paging, paginationInfoChan, true, paging.ForceTotalCount)
	} else {
